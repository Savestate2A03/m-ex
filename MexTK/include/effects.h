...
extern u16 stc_ptclnum;      // number of pctls alive
extern Particle *stc_ptcl;   // last created ptcl
extern ptclGen *stc_ptclgen; // last created gen
extern ptclGen *stc_ptclgencurr;
extern u16 stc_ptclgennum;
