...
extern Stage stc_stage;
extern int stc_ftchkdevice_windnum;
extern int stc_ftchkdevice_grabnum;
extern int stc_ftchkdevice_dmgnum;
extern int stc_gr_ext_cur;
extern GrExtLookup stc_gr_lookup_cur;
extern LineRange stc_line_range;
extern GOBJ *stc_stage_hud_gobj; // points to a gobj that gets rendered to the hud camera
