...
/*** Variables ***/
extern MnSlChrData stc_css_data;         // 0x803f0a48
extern VSMinorData *stc_css_minorscene;  // -0x49F0
extern u8 stc_css_regtagnum;             // -0x49A8, number of registered tags
extern s8 stc_css_name_ply;              // -0x49A7, index of the player using the name entry menu
extern HSD_Archive *stc_css_archive;     // -0x49D0
extern HSD_Archive *stc_css_menuarchive; // -0x49CC, ptr to MnMaExt archive
extern u8 stc_css_custom_rules;          // -0x49AC
extern GOBJ *stc_css_menugobj;           // -0x49E4
extern JOBJ *stc_css_menumodel;          // -0x49E0
extern JOBJ *stc_css_trainingmodel;      // -0x49DC
extern JOBJ *stc_css_highscoremodel;     // -0x49D8
extern JOBJ *stc_css_cameramodel;        // -0x49D4
extern CSSCursor *stc_css_cursors;       // 0x804a0bc0
extern CSSPuck *stc_css_pucks;           // 0x804a0bd0

extern s8 stc_css_hmnport;                      // -0x49B0
extern s8 stc_css_cpuport;                      // -0x49AF
extern u8 stc_css_delay;                        // -0x49AE
extern u8 stc_css_exitkind;                     // -0x49AA
extern u8 stc_css_maxply;                       // -0x49AB
extern u8 stc_css_is_ready_timer;               // -0x49A9
extern u8 stc_css_singeplyport;                 // -0x4DE0
extern u8 stc_menu_singeplyport;                // -0x4DB8
extern Text *stc_css_ply1_combo_text;           // -0x49C4
extern Text *stc_css_ply2_combo_text;           // -0x49C0
extern Text *stc_css_ply3_combo_text;           // -0x49BC
extern Text *stc_css_ply4_combo_text;           // -0x49B8
extern int stc_css_bgtimer;                     // -0x49B4
extern u8 stc_css_hasreleasedb;                 // -0x49AD
extern MnSelectChrDataTable *stc_css_datatable; // -0x49EC
extern JOBJSet *stc_css_jobjsets;               // -0x49C8
extern COBJDesc *stc_css_cobjdesc;              // -0x4ADC
extern GOBJ *stc_css_camgobj;                   // -0x49E8
extern HSD_Pad stc_css_pad;                     // 0x804c20bc
extern u8 stc_css_unkarr;                       // 0x804d50c8
